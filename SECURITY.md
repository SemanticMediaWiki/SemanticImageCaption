...
Security fixes are provided for the latest major version of Semantic Image Caption.
...
[private vulnerability reporting](https://github.com/SemanticMediaWiki/SemanticImageCaption/security/advisories/new).
...
Semantic Image Caption is an extension to MediaWiki that builds on Semantic MediaWiki.
If the issue is actually in one of those rather than in Semantic Image Caption itself,
